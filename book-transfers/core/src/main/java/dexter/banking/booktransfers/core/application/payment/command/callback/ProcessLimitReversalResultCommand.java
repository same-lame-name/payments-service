...
public class ProcessLimitReversalResultCommand extends AbstractEnrichableCommand<Void> { // Extend the abstract base class

    private final UUID transactionId;
    private final LimitEarmarkResult result;
