...
public class ManualInterventionRequiredWebhookListener implements DomainEventListener<ManualInterventionRequiredEvent> {
    ...
    public void on(ManualInterventionRequiredEvent event) {
        ...
        log.info("Manual intervention required for transaction {}. Notifying via webhook {} for state {}", event.aggregateId(), webhookUrl, finalState);
