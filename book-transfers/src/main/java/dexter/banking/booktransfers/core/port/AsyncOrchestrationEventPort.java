...
public interface AsyncOrchestrationEventPort {
    ...
    void processDebitLegReversalResult(UUID transactionId, DebitLegResult result);
    void processLimitEarmarkReversalResult(UUID transactionId, LimitEarmarkResult result);
}
